      ...
      <div className="navbar-start  w-1/3 lg:w-1/4">
        ...
        <div className="dropdown lg:hidden">
          <div
            tabIndex={0}
            role="button"
            className="btn btn-ghost text-white px-0 pl-2 sm:px-2 mr-2"
          >
            <svg
          ...
          <ul
            tabIndex={0}
            className="menu menu-sm dropdown-content mt-4 z-1 p-3 shadow bg-[#111] border border-neutral-800 rounded-box w-52 gap-2"
          >
            <li>
              <Link
                href="/"
